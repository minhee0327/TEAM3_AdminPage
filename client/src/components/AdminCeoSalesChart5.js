...
import AdminCeoSalesChart5_BarChart from './AdminCeoSalesChart5_BarChart';
...
class AdminClientSalesChart5 extends Component{
    ...
    render(){
        return (
            <div>
               {this.state.data.length>0 && <AdminCeoSalesChart5_BarChart data = {this.state.data} pair = {this.state.pair} data2={this.state.data2}/>}     
            </div>
        )
    }
