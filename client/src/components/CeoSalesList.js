    ...
    render(){
        return(
            ...
            <TableRow>
                ...
                <TableCell onClick={this.handleClick}><Link to = {`/api/ceoSalesList/${this.props.연락처}`}>{this.props.사장님}</Link></TableCell>
                <TableCell>{this.props.연락처}</TableCell>
                <TableCell>{this.props.극단별총매출}</TableCell>
            </TableRow>
            <Route path ="/api/ceoSalesList/:phone" component={Test}></Route>
            </div>
        )
    }
}
